...
//
//
//tatic void prop_destroy(proposal_t *prop) {
...
//* this is deprecated.
//*/
//tatic void prop_cpy(proposal_t *dest, const proposal_t *src, apr_pool_t *mp) {
//   SAFE_ASSERT(mp != NULL);
...
//*/
//tatic proposal_t *prop_copy(const proposal_t *src) {
//   SAFE_ASSERT(src != NULL);
...
//
//
//tatic void prop_free(proposal_t *prop) {
//   for (int i = 0; i < prop->n_rids; i++) {
//       free(prop->rids[i]);
//   }
//   free(prop->value.data);
...
//
//
//tatic void prop_pack(proposal_t *prop, uint8_t **buf, size_t *sz_buf) {
...
//
//
//tatic void prop_buf_free(uint8_t *buf) {
//   free(buf);
//
//
//
/// TODO
//tatic void prop_unpack(uint8_t *buf, size_t sz_buf, proposal_t **prop) {
//
//
