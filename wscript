...
def build(bld):
    ...
    bld.stlib(source=bld.path.ant_glob(['libmpaxos/view.cpp', 'libmpaxos/mpaxos.proto'
                                        'libmpaxos/proposer.cpp', 'libmpaxos/acceptor.cpp']), 
                                      #  'libmpaxos/captain.cpp', 'libmpaxos/commo.cpp']), 
              target="mpaxos",
              includes="libmpaxos",
              use="PROTOBUF",
              install_path="${PREFIX}/lib")

    bld.program(source=['test/test_proposer.cpp', 'libmpaxos/mpaxos.proto',
                        'libmpaxos/proposer.cpp', 'libmpaxos/acceptor.cpp'], 
    ...
    bld.program(source=['test/test_me.cpp', 'libmpaxos/mpaxos.proto'], 
                target="test_me", 
                includes="libmpaxos", 
                use=['PROTOBUF'], 
                install_path=False)
